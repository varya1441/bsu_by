    ...
    public Application() {
        ...
        convertToHTML.addActionListener(e -> {
            ...
            if (option == JFileChooser.APPROVE_OPTION) {
                try {
                    ...
                    Transformer  transformer = factory.newTransformer(new StreamSource(AlbumTableModel.class.getClassLoader().getResourceAsStream("html.xsl")));
        ...
        convertToTXT.addActionListener(e -> {
            ...
            if (option == JFileChooser.APPROVE_OPTION) {
                try {
                    TransformerFactory factory = TransformerFactory.newInstance();
                    Transformer transformer = factory.newTransformer(new StreamSource(AlbumTableModel.class.getClassLoader().getResourceAsStream("txt.xsl")));
